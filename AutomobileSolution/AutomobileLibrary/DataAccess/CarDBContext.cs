...
namespace AutomobileLibrary.DataAccess
{
    public class CarDBContext
    {
        private static List<Car> CarList = new List<Car>()
        {
            ...
            new Car{ CarId =3, CarName="Mustang", Manufacturer="Ford", Price=50000, ReleaseYear=2023},
            new Car{ CarId =4, CarName="Poscher 911", Manufacturer="Poscher", Price=65000, ReleaseYear=2020},
        };
